...
# code.
#
# While the `safaridriver` binary offers an `--enable` flag [1], that flag
# prompts for the current user's password via standard input, making it
# unsuitable for use in fully-automated contexts.
#
